...
from strap.retrieval.retrieval_helper_ot import run_retrieval, save_results
import numpy as np
import random
...
def get_args():
    ...
    return RetrievalArgs(
        ...
        output_path=f"{REPO_ROOT}/data/retrieval_results/metadata-ot-stove-pot_retrieved_dataset.hdf5",
        model_key="DINOv2",
